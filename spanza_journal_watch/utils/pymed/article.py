...
class PubMedArticle:
    ...
    def __init__(
        self: object,
        xml_element: TypeVar("Element") | None = None,
        *args: list,
        **kwargs: dict,
    ) -> None:
    ...
    def _extractPubMedId(self: object, xml_element: TypeVar("Element")) -> str:
        # Fix ID parsing issue
        # https://github.com/gijswobben/pymed/pull/30/commits/54cd94af44379487ee3d1287216cc91651de16e1
    ...
    def _extractKeywords(self: object, xml_element: TypeVar("Element")) -> str:
        path = ".//Keyword"
        return [keyword.text for keyword in xml_element.findall(path) if keyword is not None]
    ...
    def _extractPublicationDate(self: object, xml_element: TypeVar("Element")) -> TypeVar("datetime.datetime"):
        ...
        try:
            ...
            return datetime.date(year=publication_year, month=publication_month, day=publication_day)

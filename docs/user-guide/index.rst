...
These guides cover the editorial workflow for each role in Journal Watch.
...
Journal Watch has three editorial roles:

**Chief editor**
   Full access to all editorial functions. Manages issues from creation through
   publication, controls article intake, manages contributors, and maintains
   system settings.

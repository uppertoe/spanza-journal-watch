...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=[".journalwatch.org.au"]) + ["django"]
...
# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "spanza_journal_watch.utils.storages.MediaRootS3Boto3Storage"
...
AWS_DEFAULT_REGION = env("DJANGO_AWS_DEFAULT_REGION", default="ap-southeast-2")
# ADMIN
# ------------------------------------------------------------------------------
